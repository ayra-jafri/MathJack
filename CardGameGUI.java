...
public class CardGameGUI extends JFrame implements ActionListener{
    ...
    private static final int DEFAULT_WIDTH = 1006;/*800;*/
    /** Width of a card. */
    ...
    private static final int BUTTON_LEFT = 570+206;
    ...
    private static final int LABEL_LEFT = 540+206;
    ...
    private JLabel rules2Msg;
    private JLabel rules3Msg;
    private JLabel rules4Msg;
    ...
    private void initDisplay()  {
        panel = new JPanel() {
            public void paintComponent(Graphics g) {
                ...
                if(varWrap.getDark() == true){setBackground(new Color (40,43,48));}
        ...
        if(varWrap.getDark() == true){
            ...
            statusMsg.setForeground(new Color (40,43,48));
        }
        ...
        rulesMsg = new JLabel();
        rulesMsg.setBounds(LABEL_LEFT, LABEL_TOP + LABEL_HEIGHT_INC, 255, 30);
        rulesMsg.setForeground(new Color (114,137,218));
        rulesMsg.setText("Rules: You pick three cards.");
        panel.add(rulesMsg);

        rules2Msg = new JLabel();
        rules2Msg.setBounds(LABEL_LEFT, LABEL_TOP + LABEL_HEIGHT_INC, 255, 60);
        rules2Msg.setForeground(new Color (114,137,218));
        ...
        rules3Msg.setForeground(new Color (114,137,218));
        ...
        rules4Msg.setForeground(new Color (114,137,218));
        rules4Msg.setText("to the other one.");
        panel.add(rules4Msg);
       
        points1 = new JLabel();
        points1.setBounds(LABEL_LEFT, LABEL_TOP + LABEL_HEIGHT_INC, 255, 150);
        points1.setForeground(new Color (114,137,218));
        points1.setText("Jacks are worth 11 pts, Queens are 12,");
        panel.add(points1);
        
        points2 = new JLabel();
        points2.setBounds(LABEL_LEFT, LABEL_TOP + LABEL_HEIGHT_INC, 255, 180);
        points2.setForeground(new Color (114,137,218));
        points2.setText("Kings are 13, Jokers are 0,");
        panel.add(points2);
        
        points3 = new JLabel();
        points3.setBounds(LABEL_LEFT, LABEL_TOP + LABEL_HEIGHT_INC, 255, 210);
        points3.setForeground(new Color (114,137,218));
        points3.setText("and Knights are worth nothing.");
        panel.add(points3);
        
        points4 = new JLabel();
        points4.setBounds(LABEL_LEFT, LABEL_TOP + LABEL_HEIGHT_INC, 255, 240);
        points4.setForeground(new Color (114,137,218));
        points4.setText("If there is a knight card in your hand,");
        panel.add(points4);
        
        points5 = new JLabel();
        points5.setBounds(LABEL_LEFT, LABEL_TOP + LABEL_HEIGHT_INC, 255, 270);
        points5.setForeground(new Color (114,137,218));
        ...
        cardPlayy.setForeground(new Color (40,43,48));
        ...
        totalsMsg.setForeground(new Color (40,43,48));
        totalsMsg.setText("You've won " + totalWins
            + " out of " + totalGames + " games.");
